...
/*
#define IS_RTC_COMPEN_FREQ(clk) (((clk) == RTC_COMPENFREQ_AS_4MHZ) || \
                                     ((clk) == RTC_COMPENFREQ_AS_6MHZ) || \
                                     ((clk) == RTC_COMPENFREQ_AS_8MHZ) || \
                                     ((clk) == RTC_COMPENFREQ_AS_12MHZ) || \
                                     ((clk) == RTC_COMPENFREQ_AS_16MHZ) || \
                                     ((clk) == RTC_COMPENFREQ_AS_20MHZ) || \
                                     ((clk) == RTC_COMPENFREQ_AS_24MHZ) || \
                                     ((clk) == RTC_COMPENFREQ_AS_30MHZ) || \
                                     ((clk) == RTC_COMPENFREQ_AS_48MHZ)) 
*/
...
/*
#define IS_RTC_COMPEN_STEP(stp) (((stp) == RTC_COMPENSTEP_0_950PPM) || \
                                     ((stp) == RTC_COMPENSTEP_0_238PPM) || \
                                     ((stp) == RTC_COMPENSTEP_0_119PPM))                                       )
*/
...
/*
#define IS_RTC_WEEKDAY(wek) (((wek) == RTC_Weekday_Monday) || \
