...
/* SYSCTRL HSI --------------------------------------------------------*/
#ifdef __PRIVATE_DEBUG
#define RCC_HSI_TRIMCODEADDR             (0x001007ACU)   //CHIP1
#else
#define RCC_HSI_TRIMCODEADDR             (0x00012600U)   //CHIP2
#endif
...
/* SYSCTRL LSI --------------------------------------------------------*/
#ifdef __PRIVATE_DEBUG
#define RCC_LSI_TRIMCODEADDR             (0x001007B2U)   //CHIP1
#else
#define RCC_LSI_TRIMCODEADDR             (0x00012602U)     //CHIP2
#endif
